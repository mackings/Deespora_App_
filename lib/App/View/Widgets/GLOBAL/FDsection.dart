...
class GlobalDetailsSection extends StatefulWidget {
  ...
  @override
  State<GlobalDetailsSection> createState() => _GlobalDetailsSectionState();
}

class _GlobalDetailsSectionState extends State<GlobalDetailsSection> {
  LatLng? _coordinates;
